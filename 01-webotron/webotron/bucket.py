...
class BucketManager:
    ...
    def gen_etag(self, path):
        ...
        if not hashes:
            ...
            # Takes a hash of each part of the data.
            # Uses the reduce function. It takes an anonymous function (lambda) and
            # a list of items. It'll iterate through the items and append each element to the previous one
